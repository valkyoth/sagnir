...
- Separated bootstrap, unlock, authoritative, and recovery crypto capabilities;
  ...
  boundaries. Removed transition-hash and portable-file-immutability assumptions.
- Added roadmap contracts for governed work-cost table selection, non-circular
  ...
  records, crash-idempotent operation capabilities, and integrity-bound
  quarantine capture. Clarified outer integrity versus sender authenticity and
  the detectable-on-reconciliation limit for disconnected clone forks.
...
- Added uncertain external key-destruction recovery, authenticated private
  locator indexes with replica quotas, conflict-safe duplicate representatives,
