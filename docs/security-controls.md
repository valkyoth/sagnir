...
| Index completeness | Deterministic semantic-ledger projection, full-rebuild/delta proofs, full-view replay, and optional threshold witnesses prevent an authorized signer from omitting or inventing logical entries; partial-access trust is explicit | Planned | `docs/protocol.md`, `docs/VERSION_PLAN.md` |
