...
| Solo release assurance | Maintainer pentest scope expands with cryptographic and trust boundaries; Codex fixes findings and CI failures, records their resolution in the permanent report, and tags only after green pentest, green CI, and explicit instruction | Policy | `docs/release-runbook.md`, `docs/VERSION_PLAN.md` |
